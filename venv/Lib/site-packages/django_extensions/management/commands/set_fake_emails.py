...
set_fake_emails.py
    ...
    Give all users a new email auth. Useful for testing in a
...
class Command(BaseCommand):
    help = '''DEBUG only: give all users a new email based on their auth data ("%s" by default). Possible parameters are: username, first_name, last_name''' % (DEFAULT_FAKE_EMAIL, )
